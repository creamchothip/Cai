...
<body>
    ...
    <div class="lesson-box1_5">
        <strong>1.ไม่เผยแพร่ข้อมูลส่วนตัว</strong><p>
            <br>1.1 ควรพิจารณาและตั้งค่าความเป็นส่วนตัวก่อนโพสต์ข้อมูลส่วนตัว เช่น ข้อมูลที่เกี่ยวกับชื่อ, ที่อยู่, เบอร์โทรศัพท์
            <br>1.2 หลีกเลี่ยงการโพสต์ข้อมูลที่สามารถระบุตัวตนของคุณได้ง่าย เช่น สถานที่ที่คุณไปบ่อย หรือสถานที่ทำงานที่อาจนำไปสู่การทำร้าย
            <br>1.3 ใช้การตั้งค่าความเป็นส่วนตัวในแพลตฟอร์มต่าง ๆ เช่น เฟซบุ๊ก, อินสตาแกรม หรือทวิตเตอร์ เพื่อจำกัดการเข้าถึงข้อมูลของคุณ
        </p>
    </div>
    <img src='../../picture_all/นักเรียนชาย (2).png' alt="รูปภาพ" class="image2_extest1_5"> 
    ...
    <script>
        ...
        // ฟังก์ชันจับเวลา 1 นาที 30 วินาที
        function startTimer() {
            let timeRemaining = 105; // 1 นาที 30 วินาที = 90 วินาที
    ...
    <!-- ปุ่มเริ่มสอบ -->
    <form method="post">
        <input type="submit" class="buttoninput_extest1" formaction="Lesson1.5.1.php" formmethod="POST" value="ต่อไป" >
    </form>

    <img src="../../picture_all/ครู2.png" alt="รูปภาพ" class="image1_extest1_5">
</body>
</html>
