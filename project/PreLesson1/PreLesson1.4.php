...
<head>
    ...
    <script>
        ...
        function startReading() {
            ...
            speech.text = "ข้อ 4: หากมีคนแปลกหน้าขอให้เราส่งที่อยู่บ้านให้ ควรทำอย่างไร?" + 
...
<body>
    <form action="Save_PreLesson4.php" method="POST" onsubmit="return validateForm();">
        <input type="hidden" name="stp3_name" value="<?php echo htmlspecialchars($stp3_name); ?>">

		
        <div class="quiz-container">
            <fieldset>
                <legend>ข้อ 4: หากมีคนแปลกหน้าขอให้เราส่งที่อยู่บ้านให้ ควรทำอย่างไร ?</legend>
                <br><br>
                <label>
                    <input type="radio" name="q4" value="0"> ก. ส่งให้ทันทีเพื่อให้เขามาเยี่ยม
                </label><br>
                <label>
                    <input type="radio" name="q4" value="1"> ข. บอกพ่อแม่หรือผู้ปกครองก่อน
                </label><br>
                <label>
                    <input type="radio" name="q4" value="0"> ค. ไม่โพสต์ลงในโซเชียลเพื่อให้เพื่อน ๆรู้
                </label><br>
