...
<head>
    ...
    <script>
        ...
        function startReading() {
            ...
            speech.text = "ข้อ 5: การใช้เวลาหน้าจออินเทอร์เน็ตที่เหมาะสมคือแบบใด" + 
...
<body>
    <form action="Save_PreLesson5.php" method="POST" onsubmit="return validateForm();">

		
        <div class="quiz-container">
            <fieldset>
                <legend>ข้อ 5: การใช้เวลาหน้าจออินเทอร์เน็ตที่เหมาะสมคือแบบใด ?</legend>
                <br><br>
                <label>
                    <input type="radio" name="q5" value="0"> ก. เล่นเกมออนไลน์ได้ตลอดเวลา
                </label><br>
                <label>
                    <input type="radio" name="q5" value="1"> ข. ใช้เมื่อจำเป็นและกำหนดเวลาให้พอเหมาะ
                </label><br>
                <label>
                    <input type="radio" name="q5" value="0"> ค.  ดูวิดีโอออนไลน์ทั้งวันโดยไม่หยุดพัก
                </label><br>
