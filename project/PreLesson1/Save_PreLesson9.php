...
$PreLesson1_9 = isset($_POST['q9']) ? intval($_POST['q9']) : 0;
...
$total_score1_9 = $old_score + $PreLesson1_9;

// SQL อัปเดตข้อมูลคะแนนของผู้ใช้
$sql_update_score = "UPDATE stp3_scores SET PreLesson1 = '$total_score1_9' WHERE stp3_name = '$stp3_name'";

if (mysqli_query($conn, $sql_update_score)) {
    echo "✅ บันทึกข้อมูลสำเร็จ! คะแนนรวม: " . $total_score1_9;

    // เปลี่ยนเส้นทางไปหน้า Lesson1.1.html
    header("Location: PreLesson1.10.php");
