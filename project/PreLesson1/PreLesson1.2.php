...
<head>
    ...
    <script>
        ...
        function startReading() {
            ...
            speech.text = "ข้อ 2: ควรใช้สื่ออินเทอร์เน็ตในช่วงเวลาใดจึงจะเหมาะสมที่สุด ?" + 
...
<body>
    <form action="Save_preLesson2.php" method="POST" onsubmit="return validateForm();">
        <input type="hidden" name="stp3_name" value="<?php echo htmlspecialchars($stp3_name); ?>">


        <div class="quiz-container">
            <fieldset>
                <legend>ข้อ 2: ควรใช้สื่ออินเทอร์เน็ตในช่วงเวลาใดจึงจะเหมาะสมที่สุด ?</legend>
                <br><br>
                <label>
                    <input type="radio" name="q2" value="1"> ก. หลังจากทำการบ้านเสร็จ
                </label><br>
                <label>
                    <input type="radio" name="q2" value="0"> ข. ระหว่างเรียนหนังสือ
                </label><br>
                <label>
                    <input type="radio" name="q2" value="0"> ค. ตลอดทั้งวันโดยไม่มีการพัก
                </label><br>
