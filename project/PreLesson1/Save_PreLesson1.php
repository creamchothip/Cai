...
$PreLesson1_1 = isset($_POST['q1']) ? intval($_POST['q1']) : 0;

// คำนวณคะแนนรวม
$total_score1_1  = $PreLesson1_1 ;

// SQL อัปเดตข้อมูลคะแนนของผู้ใช้
$sql = "UPDATE stp3_scores SET PreLesson1 = '$total_score1_1' WHERE stp3_name = '$stp3_name'";

if (mysqli_query($conn, $sql)) {
    echo "✅ บันทึกข้อมูลสำเร็จ! คะแนนรวม: " . $total_score1_1;

    // เปลี่ยนเส้นทางไปหน้า Lesson1.1.html
    header("Location: PreLesson1.2.php");
