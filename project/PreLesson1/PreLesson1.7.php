...
<head>
    ...
    <script>
        ...
        function startReading() {
            ...
            speech.text = "ข้อ 7: เหตุใดจึงต้องให้ผู้ปกครองช่วยดูแลการใช้อินเทอร์เน็ตของเรา" + 
...
<body>
    <form action="Save_PreLesson7.php" method="POST" onsubmit="return validateForm();">
        
		
		
        <div class="quiz-container">
            <fieldset>
                <legend>ข้อ 7: เหตุใดจึงต้องให้ผู้ปกครองช่วยดูแลการใช้อินเทอร์เน็ตของเรา ?</legend>
                <br><br>
                <label>
                    <input type="radio" name="q7" value="1"> ก. เพื่อให้แน่ใจว่าใช้งานอย่างปลอดภัย
                </label><br>
                <label>
                    <input type="radio" name="q7" value="0"> ข. เพราะผู้ปกครองอยากรู้ทุกเรื่องของเรา
                </label><br>
                <label>
                    <input type="radio" name="q7" value="0"> ค.  เพื่อให้พ่อแม่ได้เล่นอินเทอร์เน็ตด้วย
                </label><br>
