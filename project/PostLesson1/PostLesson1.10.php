...
<head>
    ...
    <script>
        ...
        function startReading() {
            ...
            speech.text = "ข้อ 10: ข้อมูลใดไม่ควรนำไปเผยแพร่บนอินเทอร์เน็ต?" + 
...
<body>
    <form action="Save_PostLesson10.php" method="POST">
        <input type="hidden" name="stp3_name" value="<?php echo htmlspecialchars($stp3_name); ?>">

        <div class="quiz-container">
            <fieldset>
                <legend>ข้อ 10: ข้อมูลใดไม่ควรนำไปเผยแพร่บนอินเทอร์เน็ต?</legend>
                <br><br>
                <label>
                    <input type="radio" name="q10" value="0"> ก. ชื่อเล่นของตนเอง
                </label><br>
                <label>
                    <input type="radio" name="q10" value="1"> ข. เบอร์โทรศัพท์ของพ่อแม่
                </label><br>
                <label>
                    <input type="radio" name="q10" value="0"> ค. ภาพวาดการ์ตูนที่ชอบ
                </label><br>
