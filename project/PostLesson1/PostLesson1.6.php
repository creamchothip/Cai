...
<head>
    ...
    <script>
        ...
        function startReading() {
            ...
            speech.text = "ข้อ 6: การใช้เวลาหน้าจออินเทอร์เน็ตที่เหมาะสมคือแบบใด" + 
                " ก.ไก่  เล่นเกมออนไลน์ได้ตลอดเวลา" + 
                " ข.ไข่  ใช้เมื่อจำเป็นและกำหนดเวลาให้พอเหมาะ" + 
                " ค.ควาย  ดูวิดีโอออนไลน์ทั้งวันโดยไม่หยุดพัก";
            speech.rate = 0.7;
...
<body>
    <form action="Save_PostLesson6.php" method="POST" onsubmit="return validateForm();">
		<input type="hidden" name="stp3_name" value="<?php echo htmlspecialchars($stp3_name); ?>">

		
        <div class="quiz-container">
            <fieldset>
                <legend>ข้อ 6: การใช้เวลาหน้าจออินเทอร์เน็ตที่เหมาะสมคือแบบใด ?</legend>
                <br><br>
                <label>
                    <input type="radio" name="q6" value="0"> ก. เล่นเกมออนไลน์ได้ตลอดเวลา
                </label><br>
                <label>
                    <input type="radio" name="q6" value="1"> ข. ใช้เมื่อจำเป็นและกำหนดเวลาให้พอเหมาะ
                </label><br>
                <label>
                    <input type="radio" name="q6" value="0"> ค.  ดูวิดีโอออนไลน์ทั้งวันโดยไม่หยุดพัก
                </label><br>
