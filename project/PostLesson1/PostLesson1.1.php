...
<head>
    ...
    <script>
        ...
        function startReading() {
            ...
            speech.text = "ข้อ 1: ควรทำอย่างไรหากได้รับข้อความจากคนที่ไม่รู้จักในอินเทอร์เน็ต?" + 
        ...
        window.onload = function() {
            startTimer();
            setTimeout(startReading, 500); // เรียกใช้ startReading หลังจาก 0.5 วินาที
        };
    </script>
</head>
<body>
    <form action="Save_PostLesson1.php" method="POST" onsubmit="return validateForm();">
        <input type="hidden" name="stp3_name" value="<?php echo htmlspecialchars($stp3_name); ?>">

        <div class="quiz-container">
            <fieldset>
                <legend>ข้อ 1: ควรทำอย่างไรหากได้รับข้อความจากคนที่ไม่รู้จักในอินเทอร์เน็ต?</legend>
                <br>
                <label><input type="radio" name="q1" value="0"> ก. ตอบกลับและพูดคุยกับเขา</label><br>
                <label><input type="radio" name="q1" value="1"> ข. บอกผู้ปกครองหรือคุณครู</label><br>
                <label><input type="radio" name="q1" value="0"> ค. ให้ข้อมูลส่วนตัวเพื่อทำความรู้จัก</label><br>
