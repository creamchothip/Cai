...
<head>
    ...
    <script>
        ...
        function startReading() {
            ...
            speech.text = "ข้อ 7: หากมีคนแปลกหน้าขอให้เราส่งที่อยู่บ้านให้ ควรทำอย่างไร?" + 
                " ก.ไก่  ส่งให้ทันทีเพื่อให้เขามาเยี่ยม" + 
                " ข.ไข่  บอกพ่อแม่หรือผู้ปกครองก่อน" + 
                " ค.ควาย  ไม่โพสต์ลงในโซเชียลเพื่อให้เพื่อน ๆ รู้";
            speech.rate = 0.7;
...
<body>
    <form action="Save_PostLesson7.php" method="POST" onsubmit="return validateForm();">
        
		
		
        <div class="quiz-container">
            <fieldset>
                <legend>ข้อ 7: หากมีคนแปลกหน้าขอให้เราส่งที่อยู่บ้านให้ ควรทำอย่างไร ?</legend>
                <br><br>
                <label>
                    <input type="radio" name="q7" value="0"> ก. ส่งให้ทันทีเพื่อให้เขามาเยี่ยม
                </label><br>
                <label>
                    <input type="radio" name="q7" value="1"> ข. บอกพ่อแม่หรือผู้ปกครองก่อน
                </label><br>
                <label>
                    <input type="radio" name="q7" value="0"> ค. ไม่โพสต์ลงในโซเชียลเพื่อให้เพื่อน ๆรู้
                </label><br>
