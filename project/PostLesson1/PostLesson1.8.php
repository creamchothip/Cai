...
<head>
    ...
    <script>
        ...
        function startReading() {
            ...
            speech.text = "ข้อ 8: ถ้าเพื่อนในห้องแชตใช้คำพูดไม่สุภาพ เราควรทำอย่างไร?" + 
                " ก.ไก่  ตอบโต้ด้วยคำพูดหยาบเช่นกัน" + 
                " ข.ไข่  แจ้งผู้ปกครองหรือคุณครูให้ช่วยดูแล" + 
                " ค.ควาย  ไม่สนใจและใช้คำพูดหยาบตอบกลับ";
...
<body>
    <form action="Save_PostLesson8.php" method="POST" onsubmit="return validateForm();">
        <input type="hidden" name="stp3_name" value="<?php echo htmlspecialchars($stp3_name); ?>">
		
        <div class="quiz-container">
            <fieldset>
                <legend>ข้อ 8: ถ้าเพื่อนในห้องแชตใช้คำพูดไม่สุภาพ เราควรทำอย่างไร ?</legend>
                <br><br>
                <label>
                    <input type="radio" name="q8" value="0"> ก. ตอบโต้ด้วยคำพูดหยาบเช่นกัน
                </label><br>
                <label>
                    <input type="radio" name="q8" value="1"> ข. แจ้งผู้ปกครองหรือคุณครูให้ช่วยดูแล
                </label><br>
                <label>
                    <input type="radio" name="q8" value="0"> ค. ไม่สนใจและใช้คำพูดหยาบตอบกลับ
                </label><br>
