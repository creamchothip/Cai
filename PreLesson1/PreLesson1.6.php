...
<head>
    ...
    <script>
        ...
        function startReading() {
            ...
            speech.text = "ข้อ 6: ถ้าพบข้อมูลที่ไม่น่าเชื่อถือบนอินเทอร์เน็ต ควรทำอย่างไร" + 
...
<body>
    <form action="Save_PreLesson6.php" method="POST" onsubmit="return validateForm();">
		<input type="hidden" name="stp3_name" value="<?php echo htmlspecialchars($stp3_name); ?>">

		
        <div class="quiz-container">
            <fieldset>
                <legend>ข้อ 6: ถ้าพบข้อมูลที่ไม่น่าเชื่อถือบนอินเทอร์เน็ต ควรทำอย่างไร ?</legend>
                <br><br>
                <label>
                    <input type="radio" name="q6" value="0"> ก. แชร์ให้เพื่อนดูก่อน
                </label><br>
                <label>
                    <input type="radio" name="q6" value="1"> ข. ตรวจสอบแหล่งข้อมูลหรือถามคุณครู
                </label><br>
                <label>
                    <input type="radio" name="q6" value="0"> ค.  เชื่อทันทีโดยไม่ต้องตรวจสอบ
                </label><br>
