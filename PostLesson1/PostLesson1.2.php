...
<head>
    ...
    <script>
        ...
        function startReading() {
            ...
            speech.text = "ข้อ 2: ข้อใด เป็นประโยชน์ จากการใช้สื่ออินเทอร์เน็ตอย่างถูกต้อง" + 
                " ก.ไก่  ได้รับความรู้และข้อมูลที่ดี" + 
                " ข.ไข่  สามารถเล่นเกมได้ทั้งวัน" + 
                " ค.ควาย  สามารถพูดคุยกับคนแปลกหน้าได้";
            speech.rate = 0.7;
...
<body>
    <form action="Save_PostLesson2.php" method="POST" onsubmit="return validateForm();">
        <input type="hidden" name="stp3_name" value="<?php echo htmlspecialchars($stp3_name); ?>">


        <div class="quiz-container">
            <fieldset>
                <legend>ข้อ 2: ข้อใด <strong>เป็นประโยชน์</strong> จากการใช้สื่ออินเทอร์เน็ตอย่างถูกต้อง ?</legend>
                <br><br>
                <label>
                    <input type="radio" name="q2" value="1"> ก. ได้รับความรู้และข้อมูลที่ดี
                </label><br>
                <label>
                    <input type="radio" name="q2" value="0"> ข. สามารถเล่นเกมได้ทั้งวัน
                </label><br>
                <label>
                    <input type="radio" name="q2" value="0"> ค.  สามารถพูดคุยกับคนแปลกหน้าได้
                </label><br>
