...
<head>
    ...
    <script>
        ...
        function startReading() {
            ...
            speech.text = "ข้อ 5: ถ้าพบข้อมูลที่ไม่น่าเชื่อถือบนอินเทอร์เน็ต ควรทำอย่างไร" + 
                " ก.ไก่  แชร์ให้เพื่อนดูก่อน" + 
                " ข.ไข่  ตรวจสอบแหล่งข้อมูลหรือถามคุณครู" + 
                " ค.ควาย  เชื่อทันทีโดยไม่ต้องตรวจสอบ";
            speech.rate = 0.7;
...
<body>
    <form action="Save_PostLesson5.php" method="POST" onsubmit="return validateForm();">

		
        <div class="quiz-container">
            <fieldset>
                <legend>ข้อ 5: ถ้าพบข้อมูลที่ไม่น่าเชื่อถือบนอินเทอร์เน็ต ควรทำอย่างไร ?</legend>
                <br><br>
                <label>
                    <input type="radio" name="q5" value="0"> ก. แชร์ให้เพื่อนดูก่อน
                </label><br>
                <label>
                    <input type="radio" name="q5" value="1"> ข. ตรวจสอบแหล่งข้อมูลหรือถามคุณครู
                </label><br>
                <label>
                    <input type="radio" name="q5" value="0"> ค.  เชื่อทันทีโดยไม่ต้องตรวจสอบ
                </label><br>
