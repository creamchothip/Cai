...
<head>
    ...
    <script>
        ...
        function startReading() {
            ...
            speech.text = "ข้อ 4: เหตุใดจึงต้องให้ผู้ปกครองช่วยดูแลการใช้อินเทอร์เน็ตของเรา" + 
                " ก.ไก่  เพื่อให้แน่ใจว่าใช้งานอย่างปลอดภัย" + 
                " ข.ไข่  เพราะผู้ปกครองอยากรู้ทุกเรื่องของเรา" + 
                " ค.ควาย  เพื่อให้พ่อแม่ได้เล่นอินเทอร์เน็ตด้วย";
            speech.rate = 0.7;
...
<body>
    <form action="Save_PostLesson4.php" method="POST" onsubmit="return validateForm();">
        <input type="hidden" name="stp3_name" value="<?php echo htmlspecialchars($stp3_name); ?>">

		
        <div class="quiz-container">
            <fieldset>
                <legend>ข้อ 4: เหตุใดจึงต้องให้ผู้ปกครองช่วยดูแลการใช้อินเทอร์เน็ตของเรา ?</legend>
                <br><br>
                <label>
                    <input type="radio" name="q4" value="1"> ก. เพื่อให้แน่ใจว่าใช้งานอย่างปลอดภัย
                </label><br>
                <label>
                    <input type="radio" name="q4" value="0"> ข. เพราะผู้ปกครองอยากรู้ทุกเรื่องของเรา
                </label><br>
                <label>
                    <input type="radio" name="q4" value="0"> ค.  เพื่อให้พ่อแม่ได้เล่นอินเทอร์เน็ตด้วย
                </label><br>
