...
<head>
    ...
    <script>
        ...
        function startReading() {
            ...
            speech.text = "ข้อ 3: ควรทำอย่างไรเมื่อเห็นเพื่อนโพสต์ข้อความไม่สุภาพบนอินเทอร์เน็ต" + 
                " ก.ไก่  แจ้งเพื่อนให้แก้ไขและใช้คำพูดที่สุภาพ" + 
                " ข.ไข่  กดไลก์และแชร์ต่อให้ทุกคนเห็น" + 
                " ค.ควาย  เขียนข้อความไม่สุภาพตอบกลับไป";
            speech.rate = 0.7;
...
<body>
    <form action="Save_PostLesson3.php" method="POST" onsubmit="return validateForm();">
        <input type="hidden" name="stp3_name" value="<?php echo htmlspecialchars($stp3_name); ?>">

        <div class="quiz-container">
            <fieldset>
                <legend>ข้อ 3: ควรทำอย่างไรเมื่อเห็นเพื่อนโพสต์ข้อความไม่สุภาพบนอินเทอร์เน็ต ?</legend>
                <br><br>
                <label>
                    <input type="radio" name="q3" value="1"> ก. แจ้งเพื่อนให้แก้ไขและใช้คำพูดที่สุภาพ
                </label><br>
                <label>
                    <input type="radio" name="q3" value="0"> ข. กดไลก์และแชร์ต่อให้ทุกคนเห็น
                </label><br>
                <label>
                    <input type="radio" name="q3" value="0"> ค.  เขียนข้อความไม่สุภาพตอบกลับไป
                </label><br>
